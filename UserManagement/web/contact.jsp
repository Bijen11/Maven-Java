            ...
            <div class="bottom bg-light sticky-top shadow-sm">
                <div class="container-nav">
                    <ul class="nav nav-bottom nav-fill">
                        ...
                        <li class="nav-item">
                            <a class="nav-link bg-primary text-white" terget="_blank" text-dark" href="contact.jsp"><i class="fas fa-cog"></i> <span class="d-none d-sm-inline-block d-md-inline-block">Contact Us</span></a>
                        </li>
                    </ul>
