<%-- 
    Document   : register
    Created on : May 31, 2020, 9:58:45 AM
    Author     : acer
--%>
        ...
        <div class="container emp-profile">
            <div class="bottom bg-light sticky-top shadow-sm">
                <div class="container-nav">
                    <ul class="nav nav-bottom nav-fill">
                        ...
                        <li class="nav-item">
                            <a class="nav-link bg-primary text-white" terget="_blank" href="register.jsp"><i class="fas fa-file-invoice"></i> <span class="d-none d-sm-inline-block d-md-inline-block">Register</span></a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container">
                <div class="regbox box">
                    <img class="avatar" src="img/collabration.png">
                    <h1>
                        Register Account</h1>
