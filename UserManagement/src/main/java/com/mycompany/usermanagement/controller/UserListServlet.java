...
public class UserListServlet extends HttpServlet {
    ...
    public void unblock(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException{
        ...
        String uname = (String) session.getAttribute("username");
        User user = new User(User_id);
        userDao.unblock(user, uname);
        response.sendRedirect(request.getContextPath()+"/UserListServlet");
    }
    
    public void blockList(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
